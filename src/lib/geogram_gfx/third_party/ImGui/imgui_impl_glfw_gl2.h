...
/* [Bruno Levy] 
 * Modified 05/16/2016 - updated 11/26/2017: geogram GL API, C API and C comments. 
 * Updated  04/11/2018 - restored GL2 suffix for callbacks (since I am using both GL2 and GL3 backends)
 */
