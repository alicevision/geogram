...
namespace ImGui
{
    ...
    IMGUI_API bool          InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* display_format = "%.6f", ImGuiInputTextFlags extra_flags = 0);
