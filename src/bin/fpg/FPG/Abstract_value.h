...
struct Abstract_value {
    ...
    virtual Abstract_value* add( Abstract_value* other ) { return clone(); }
    virtual Abstract_value* sub( Abstract_value* other ) { return clone(); }
    virtual Abstract_value* div( Abstract_value* other ) { return clone(); }
    virtual Abstract_value* mul( Abstract_value* other ) { return clone(); }
    ...
    virtual Abstract_value* add( Abstract_value* other, AST::BinaryExpression *bexp ) { return add(other); }
    virtual Abstract_value* sub( Abstract_value* other, AST::BinaryExpression *bexp ) { return sub(other); }
    virtual Abstract_value* mul( Abstract_value* other, AST::BinaryExpression *bexp ) { return mul(other); }
    virtual Abstract_value* div( Abstract_value* other, AST::BinaryExpression *bexp ) { return div(other); }
